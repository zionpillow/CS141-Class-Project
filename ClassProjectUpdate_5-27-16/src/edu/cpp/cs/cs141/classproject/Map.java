...
public class Map implements Serializable {
	 ...
	 * serialization.
	 */
	private static final long serialVersionUID = 6538852259350115773L;
	 ...
	 * @return
	 */
	public boolean look(UI.direction dir, int distance) {
		boolean detectedEnemy = false;

		switch (dir) {
		case UP:
			for (int i = (playerRow - distance); i < playerRow; ++i) {
		...
		case DOWN:
			...
			break;
		case LEFT:
			for (int i = (playerColumn - distance); i < playerColumn; ++i) {
