...
public class GameEngine {
	...
	public void saveGame(String save) {
		if (!new File(System.getProperty("user.home") + "\\Documents\\Infiltration\\Saves").exists())
			new File(System.getProperty("user.home") + "\\Documents\\Infiltration\\Saves").mkdirs();
		try {
			FileOutputStream dos = new FileOutputStream(System.getProperty("user.home") + "\\Documents\\Infiltration\\Saves\\" + save + ".dat");
	...
	public Map loadGame(String save) {
		Map map;
		try {
			FileInputStream fis = new FileInputStream(System.getProperty("user.home") + "\\Documents\\Infiltration\\Saves\\" + save + ".dat");
